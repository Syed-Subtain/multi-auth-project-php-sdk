...
namespace MultiAuthSampleLib\Exceptions;
...
class OAuthProviderException extends ApiException
{
    ...
    /**
     * @param string $reason
     * @param \MultiAuthSampleLib\Http\HttpRequest $request
     * @param \MultiAuthSampleLib\Http\HttpResponse $response
     * @param string $error
     */
    public function __construct(
        string $reason,
        \MultiAuthSampleLib\Http\HttpRequest $request,
        \MultiAuthSampleLib\Http\HttpResponse $response,
        string $error
    ) {
     ...
     * @required
     * @maps error
     * @factory \MultiAuthSampleLib\Models\OAuthProviderErrorEnum::checkValue
     */
